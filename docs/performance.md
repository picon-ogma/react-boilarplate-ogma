...
[Code Splitting Example Code](../src/AppRouter.jsx)
...
- If you develop an application that requires a state to track many elements at once, you might consider state management libraries with atomic updates such as [jotai](https://jotai.pmnd.rs/). (Highly Recommended)
...
Read: [Before You memo()](https://overreacted.io/before-you-memo/)
